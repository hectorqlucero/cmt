...
(defn generate-hook-stub
  ...
  (let [file-fields (filter #(= :file (:type %)) fields)
    ...
    (str "(ns cmt.hooks." entity-name "\n"
       ...
       (when has-file-fields? "\n  (:require [cmt.models.util :refer [image-link]])") ")\n"
       "\n"
       ";; =============================================================================\n"
       ";; Validators\n"
       ";; =============================================================================\n"
...
(defn generate-edn-content
  ...
  (let [entity-name (name (:entity config))
    ...
    (str ";; AUTO-GENERATED entity configuration for " (:table config) "\n"
         ...
         " ;; :hooks {:before-load :cmt.hooks." entity-name "/before-load\n"
         " ;;         :after-load :cmt.hooks." entity-name "/after-load\n"
         " ;;         :before-save :cmt.hooks." entity-name "/before-save\n"
         " ;;         :after-save :cmt.hooks." entity-name "/after-save\n"
         " ;;         :before-delete :cmt.hooks." entity-name "/before-delete\n"
         " ;;         :after-delete :cmt.hooks." entity-name "/after-delete}\n"
