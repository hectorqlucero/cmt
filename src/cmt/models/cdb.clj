(ns cmt.models.cdb
  (:require
   ...
   [cmt.models.crud :as crud :refer [Insert-multi Query!]]))
...
(defn seed-non-users
  "Usage:
   - lein run -m cmt.models.cdb/seed-non-users
   - lein run -m cmt.models.cdb/seed-non-users pg
   - lein run -m cmt.models.cdb/seed-non-users localdb
