(ns cmt.hooks.talleres
  "Business logic hooks for talleres entity.
...
(defn before-load
  ...
  (println "[INFO] Loading talleres with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "talleres record(s)")
...
(defn after-save
  ...
  (println "[INFO] Talleres saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if talleres can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Talleres deleted successfully. ID:" entity-id)
  {:success true})
