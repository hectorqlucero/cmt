...
(defn before-load
  ...
  (println "[INFO] Loading videos with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "videos record(s)")
...
(defn after-save
  ...
  (println "[INFO] Videos saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if videos can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Videos deleted successfully. ID:" entity-id)
  {:success true})
