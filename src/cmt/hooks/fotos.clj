(ns cmt.hooks.fotos
  "Business logic hooks for fotos entity.
...
(defn before-load
  ...
  (println "[INFO] Loading fotos with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "fotos record(s)")
...
(defn after-save
  ...
  (println "[INFO] Fotos saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if fotos can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Fotos deleted successfully. ID:" entity-id)
  {:success true})
