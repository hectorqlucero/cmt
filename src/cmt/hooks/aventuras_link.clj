(ns cmt.hooks.aventuras_link
  "Business logic hooks for aventuras_link entity.
...
(defn before-load
  ...
  (println "[INFO] Loading aventuras_link with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "aventuras_link record(s)")
...
(defn before-save
  ...
  [params]
  (println "[INFO] Saving aventuras_link...")
...
(defn after-save
  ...
  (println "[INFO] Aventuras_link saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if aventuras_link can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Aventuras_link deleted successfully. ID:" entity-id)
  {:success true})
