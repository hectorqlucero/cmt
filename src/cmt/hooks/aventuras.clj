(ns cmt.hooks.aventuras
  "Business logic hooks for aventuras entity.
...
(defn before-load
  ...
  (println "[INFO] Loading aventuras with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "aventuras record(s)")
...
(defn after-save
  ...
  (println "[INFO] Aventuras saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if aventuras can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Aventuras deleted successfully. ID:" entity-id)
  {:success true})
