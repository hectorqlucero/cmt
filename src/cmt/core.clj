(ns cmt.core
  (:require
   ...
   [cmt.models.crud :refer [config KEY]]
   [cmt.routes.proutes :refer [proutes]]
   [cmt.routes.routes :refer [open-routes password-routes]]
   [cmt.routes.i18n :refer [i18n-routes]]
   [cmt.routes.tabgrid :refer [tabgrid-routes]]
