...
;; Start build-aventuras-menus-rows
(defn build-aventuras-menus-rows []
  (Query db "select * from cmt order by nombre"))
;; End build-aventuras-menus-rows

(comment
  (build-aventuras-rows)
