(ns cmt.hooks.cmt
  "Business logic hooks for cmt entity.
...
(defn before-load
  ...
  (println "[INFO] Loading cmt with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "cmt record(s)")
...
(defn after-save
  ...
  (println "[INFO] Cmt saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if cmt can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Cmt deleted successfully. ID:" entity-id)
  {:success true})
